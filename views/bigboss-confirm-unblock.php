                    ...
                    <div class="well">
                        <section class="media">
                            ...
                            <div class="media-body">
                                ...
                                <div class="alert">
                                    <h2 class="h3 pb-4">Tens a certeza que pretende desbloquear este utilizador?</h2>
                                    <p>O utilizador voltará a poder fazer login e registar doações.</p>
                                    <p> As doações existentes serão também desbloqueadas. </p> 
                                ...
                                <div class="float-right">
                                    <div class="btn-block">
                                        <a class="delink linkdon" href="/bigboss-unblockaccount/<?php echo $blocked_user["user_id"]?>">
                                            <i class="fas fa-user-check"></i>
                                            <span class="btn-txt">Confirmo que quero desbloquear <?php echo $blocked_user["name"] ?> </span>
                                        </a>
                                    </div>
                                </div>
