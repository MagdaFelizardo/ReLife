        ...
        <header>
            <div class="container">
                ...
                <div class="searchbar float-right mb-4">
                    <form class="form-inline" action="/bigboss-searchactivedons/" method="GET">
                        <input class="form-control" type="search" name="search" placeholder="Doações activas" aria-label="search">
